...
# ... (The rest of the file, including run_processing_job, remains unchanged) ...
def run_processing_job(job_info: dict, progress_queue: Queue, cancel_event):
    ...
    try:
        ...
        green_fill, red_fill, yellow_fill, blue_fill = [PatternFill(start_color=c, end_color=c, fill_type="solid") for c in ["C6EFCE", "FFC7CE", "FFEB9C", "DDEBF7"]]
